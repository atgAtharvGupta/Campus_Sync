...
class Item_info(models.Model):
    ...
    in_no = models.CharField(max_length=200)
    spec = models.CharField(max_length=10000)
...
class Assign_item_info(models.Model):
    item_id = models.ForeignKey(Item_info, on_delete=models.DO_NOTHING)
...
class Maintain_item(models.Model):
    item_id = models.ForeignKey(Item_info, on_delete=models.DO_NOTHING)
    qty = models.PositiveIntegerField(default=1)
...
class Replace_item(models.Model):
    item_id = models.ForeignKey(Item_info, on_delete=models.DO_NOTHING)
    qty = models.PositiveIntegerField(default=1)
